...
<body>
  <div class="container">
    ...
    <div class="body">
      <h2>Subscription Status Updated</h2>
      <p>The status of your subscription for <strong>{{ $subscription->product->name }}</strong> has been updated.</p>
      ...
      <a href="{{ config('app.url') }}/dashboard/subscriptions" class="btn">View in Dashboard</a>

      <p style="font-size:13px;">If you have any questions, please contact our support team.</p>
    </div>
    <div class="footer">
