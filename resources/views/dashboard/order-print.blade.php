...
<head>
  ...
  <title>Invoice #{{ $order->id }} — AutoTerra</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .invoice-logo { display: flex; align-items: baseline; gap: 0; }
    .invoice-logo .a { color: #fff; font-size: 28px; font-weight: 800; letter-spacing: -0.5px; }
    .invoice-logo .t { color: #00A8F8; font-size: 28px; font-weight: 800; letter-spacing: -0.5px; }
    .invoice-meta { text-align: right; }
    .invoice-meta h2 { color: #fff; font-size: 22px; font-weight: 800; margin-bottom: 8px; letter-spacing: -0.3px; }
    ...
    .invoice-billed-to h4 { font-size: 10px; font-weight: 700; color: #5A7A96; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; }
    .invoice-billed-to p { font-size: 14px; color: #1C2B3A; line-height: 1.6; }
    .invoice-billed-to .name { font-weight: 700; }
    .invoice-info { text-align: right; }
    .invoice-info h4 { font-size: 10px; font-weight: 700; color: #5A7A96; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; }
    ...
    .invoice-info td:last-child { font-weight: 600; color: #1C2B3A; }
    ...
    .invoice-table thead th {
      background: #F5F8FC; padding: 12px 16px;
      font-size: 10px; font-weight: 700; color: #5A7A96;
      text-transform: uppercase; letter-spacing: 0.8px;
      text-align: left; border-bottom: 2px solid #D2DCE6;
    }
    .invoice-table thead th:last-child { text-align: right; }
    .invoice-table tbody td {
      padding: 16px; font-size: 14px; color: #1C2B3A;
    ...
    .totals-table td:last-child { text-align: right; font-weight: 600; color: #1C2B3A; }
    ...
    .payment-info table td:last-child { font-weight: 600; color: #1C2B3A; }
...
<div class="print-controls">
  <a href="/dashboard/orders/{{ $order->id }}">← Back to order</a>
